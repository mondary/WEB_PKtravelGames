...
const dbPath = path.resolve(__dirname, '../public/games.db');
...
const pigeonAdult = [
    ...
    ["Quelle est la capitale de la Mongolie ?", "Oulan-Bator", "Astana", "Tachkent"],
    ["Quel est le plus grand état des USA par sa superficie ?", "L'Alaska", "Le Texas", "La Californie"],
    ["Qui a écrit 'L'Auberge Rouge' ?", "Honoré de Balzac", "Victor Hugo", "Stendhal"],
    ["Dans quel pays se trouve le temple d'Angkor Wat ?", "Cambodge", "Laos", "Thaïlande"],
    ["Quel est le métal le plus abondant dans la croûte terrestre ?", "L'aluminium", "Le fer", "Le cuivre"],
    ["Combien de joueurs composent une équipe de baseball sur le terrain ?", "9", "7", "11"],
    ["Quelle est la capitale de la Finlande ?", "Helsinki", "Oslo", "Stockholm"],
    ["Quel fleuve traverse la ville de Budapest ?", "Le Danube", "Le Rhin", "L'Elbe"],
    ["Quel est l'oiseau le plus rapide en vol ?", "Le faucon pèlerin", "L'aigle royal", "Le martinet"],
    ["Qui a découvert la loi de la gravitation universelle ?", "Isaac Newton", "Albert Einstein", "Galilée"],
    ["Quelle est la capitale du Portugal ?", "Lisbonne", "Madrid", "Barcelone"],
    ["Combien de jours y a-t-il dans une année bissextile ?", "366", "365", "364"],
    ["Qui a peint 'Le Cri' ?", "Edvard Munch", "Vincent van Gogh", "Pablo Picasso"],
    ["Quel est l'élément chimique représenté par le symbole 'O' ?", "L'oxygène", "L'or", "L'osmium"],
    ["Quelle est la capitale de la Norvège ?", "Oslo", "Copenhague", "Reykjavik"],
    ["Quel est le plus grand désert du monde ?", "L'Antarctique", "Le Sahara", "Le Gobi"],
    ["Qui a inventé l'ampoule électrique ?", "Thomas Edison", "Nikola Tesla", "Benjamin Franklin"],
    ["Quelle est la capitale du Canada ?", "Ottawa", "Toronto", "Vancouver"],
    ["Combien y a-t-il de fuseaux horaires sur Terre ?", "24", "12", "36"],
    ["Quel est le pays le plus peuplé du monde ?", "La Chine", "L'Inde", "Les USA"],
    ["Quelle est la devise de la France ?", "Liberté, Égalité, Fraternité", "Justice, Paix, Travail", "Unité, Force, Progrès"],
    ["Quel est le plus grand océan du monde ?", "Le Pacifique", "L'Atlantique", "L'Indien"],
    ["Quelle est la capitale du Brésil ?", "Brasilia", "Rio de Janeiro", "São Paulo"],
    ["Qui a écrit 'Le Petit Prince' ?", "Antoine de Saint-Exupéry", "Albert Camus", "Jean-Paul Sartre"],
    ["Quel est le plus haut sommet du monde ?", "L'Everest", "Le K2", "Le Kilimandjaro"],
    ["Quelle est la capitale de l'Argentine ?", "Buenos Aires", "Rosario", "Córdoba"],
    ["Combien de planètes composent le système solaire ?", "8", "9", "7"],
    ["Qui a découvert l'Amérique en 1492 ?", "Christophe Colomb", "Vasco de Gama", "Fernand de Magellan"],
    ["Quelle est la capitale du Mexique ?", "Mexico", "Guadalajara", "Monterrey"],
    ["Quel est le plus long fleuve du monde ?", "Le Nil", "L'Amazone", "Le Mississippi"]
];

// Re-populating adult questions to reach 500
...
// Re-populating kid questions to reach 100
